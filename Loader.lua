...
C.ROSTER = {
    ["Burin - Bloodhoof"]           = { index = 1,  priority = 1,   class = "MAGE",         roles = {} },
    ["Bari - Bloodhoof"]            = { index = 2,  priority = 2,   class = "DEATHKNIGHT",  roles = {} },
    ["Borr - Bloodhoof"]            = { index = 3,  priority = 3,   class = "SHAMAN",       roles = {} },
    ["Mihoki - Argent Dawn"]        = { index = 4,  priority = 4,   class = "DEMONHUNTER",  roles = {} },
    ["Mokuroa - Moonglade"]         = { index = 5,  priority = 5,   class = "DRUID",        roles = {} },
    ["Jaiya - Bloodhoof"]           = { index = 6,  priority = 6,   class = "WARRIOR",      roles = {} },
    ["Gurabu - Tarren Mill"]        = { index = 7,  priority = 7,   class = "MONK",         roles = {} },
    ["Burr - Bloodhoof"]            = { index = 8,  priority = 8,   class = "PALADIN",      roles = {} },
    ["Jinrami - Silvermoon"]        = { index = 9,  priority = 9,   class = "PRIEST",       roles = {} },
    ["Fiyonse - Silvermoon"]        = { index = 10, priority = 10,  class = "EVOKER",       roles = {} },
    ["Sumoka - Tarren Mill"]        = { index = 11, priority = 11,  class = "ROGUE",        roles = {} },
    ["Brokk - Bloodhoof"]           = { index = 12, priority = 12,  class = "HUNTER",       roles = {} },
    ["Kinbo - Tarren Mill"]         = { index = 13, priority = 13,  class = "WARLOCK",      roles = {} },
